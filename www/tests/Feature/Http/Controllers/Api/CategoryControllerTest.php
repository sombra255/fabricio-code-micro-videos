...
use Tests\TestCase, Tests\Traits\TestValidations, Tests\Traits\TestSaves, Tests\Traits\TestResources;
...
class CategoryControllerTest extends TestCase
{
    ...
    public function testStore()
    {
        ...
        $response = $this->assertStore($data, $data + ['name' => 'test', 'description' => null, 'is_active' => true, 'deleted_at' => null]);
